...
"""autogenerated by genpy from graph_navigation/graph_naviActionResult.msg. Do not edit."""
import sys
...
class graph_naviActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "graph_navigation/graph_naviActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','graph_navigation/graph_naviResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(graph_naviActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = graph_navigation.msg.graph_naviResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = graph_navigation.msg.graph_naviResult()
