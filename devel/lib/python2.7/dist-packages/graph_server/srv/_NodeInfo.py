...
"""autogenerated by genpy from graph_server/NodeInfoRequest.msg. Do not edit."""
import sys
...
class NodeInfoRequest(genpy.Message):
  _md5sum = "f0260e4fab416ff57152b16538097778"
  _type = "graph_server/NodeInfoRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint64 node_id
"""
  __slots__ = ['node_id']
  _slot_types = ['uint64']
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_Q().pack(self.node_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.node_id,) = _get_struct_Q().unpack(str[start:end])
      return self
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from graph_server/NodeInfoResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class NodeInfoResponse(genpy.Message):
  ...
  _type = "graph_server/NodeInfoResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class NodeInfo(object):
  _type          = 'graph_server/NodeInfo'
  _md5sum = '2029851a1bf8e47ba40fa92c11e0df36'
